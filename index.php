    ...
    <!----  <div class="container">
      ...
      <div class="jumbotron jumbotron-fluid" style="height: 700px;">
        <div class="container text-center">
          <h1 class="display-4">EDU-COVID-19</h1>
          <br>
          <p class="lead">Pengetahuan tentang Covid-19, gejala, cara penyebaran dan penularan virus, cara pengobatan yang benar serta langkah-langkah pencegahan terhadap Covid-19. </p>
        </div>
      </div>
